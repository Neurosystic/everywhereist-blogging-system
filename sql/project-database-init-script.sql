...
INSERT INTO users (fname, lname, username, hash_password, description, birth_date, email, authToken, avatar) VALUES
	...
	-- Password = happyDays
	('Angie', 'Bethell', 'bethbeth', '$2b$10$hDA4T2AxGNgj.s7bdC4OFOA9YBH4Mc5JDLRGPNU3dWF5DdlvvmjEW', 'Blonde, shoulder-length hair almost fully covers a lean, sad face', '1995-12-08', 'user5@outlook.com', NULL, 'avatar-2.jpg'),
	-- Password = tiredTired
	('Poppy', 'Young', 'appleBerryPie', '$2b$10$2aSZRJNw0zm1g3hJm2Q5POdxkTNooYyEJIRWVkyeZ0SgiMtmjkRKu', 'Small green eyes, set wickedly within their sockets, watch honorably over the lands they have shown mercy on for so long', '1997-10-08', 'user6@hellworld.com', NULL, 'avatar-6.jpg'),
	-- Password = wohoo123
	('Harris', 'Moree', 'givemeMore', '$2b$10$j65ETuZXMqEkM7WUGnhjI.NPPyVgMM1HkHFNtc9CTixKpyHzGO5zC', 'Silver, greasy hair slightly covers a skinny, radiant face', '1949-01-16', 'user7@gmail.com', NULL, 'avatar-7.jpg');
